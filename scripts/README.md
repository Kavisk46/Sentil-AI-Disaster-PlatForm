...
**Phase 2 — Backend** of [`PROJECT_ROADMAP.md`](../PROJECT_ROADMAP.md).

Scripts added here should be documented with a short header comment
describing their purpose and usage, and should be safe to run repeatedly
